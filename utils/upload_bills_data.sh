...
if [ $BILLML_BACKUP_BILLS_DATA_CLOUD_PROVIDER = "s3" ]
    then
        ...
        AWS_ACCESS_KEY_ID=$BILLML_BACKUP_BILLS_DATA_ACCESS_KEY AWS_SECRET_ACCESS_KEY=$BILLML_BACKUP_BILLS_DATA_SECRET_KEY aws s3 sync $BILLS_LOCAL_PATH $BILLS_BUCKET_PATH
        ...
        AWS_ACCESS_KEY_ID=$BILLML_BACKUP_BILLS_DATA_ACCESS_KEY AWS_SECRET_ACCESS_KEY=$BILLML_BACKUP_BILLS_DATA_SECRET_KEY aws s3 sync $CACHE_LOCAL_PATH $CACHE_BUCKET_PATH
else
